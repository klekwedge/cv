      ...
      <div className="about__content">
        ...
        <div className="about__text ">
          ...
          <p className="about__paragraph _text ">
            ...
            функциональны, но и эстетичны. Моя работа всегда соблюдает современные стандарты и лучшие практики. Всегда
            готов учиться новым технологиям и инструментам. Я стремлюсь быть в курсе последних тенденций и применять их
            в своей работе. Моя цель - создавать продукты высокого качества, которые удовлетворяют потребности
            пользователей и достигают целей бизнеса.
          </p>
        </div>
      </div>
    </section>
